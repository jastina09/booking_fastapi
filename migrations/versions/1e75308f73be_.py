...
Revision ID: 1e75308f73be
Revises: 
Create Date: 2026-02-17 22:51:54.660513
...
def upgrade() -> None:
    ...
    sa.Column('room_status', sa.String(length=50), nullable=False),
    sa.Column('description', sa.Text(), nullable=False),
    sa.ForeignKeyConstraint(['hotel_id'], ['hotel.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('room_status')
    )
